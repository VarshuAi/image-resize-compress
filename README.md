...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/image-resize-compress.git
   cd image-resize-compress
   ```
...
[![Repo](https://img.shields.io/badge/image-resize-compress-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/image-resize-compress)
